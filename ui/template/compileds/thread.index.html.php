...
return \$__uivar_row->data('type')=='poll';")){ ?>(投票)<?php } ?> <a href="?c=groups.thread.detail&tid=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('tid');") ;?>&t=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('type');") ;?>">查看</a> <a href="?c=groups.thread.update&tid=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
return \$__uivar_row->data('tid');") ;?>&t=<?php echo eval("if(!isset(\$__uivar_row)){ \$__uivar_row=&\$aVariables->getRef('row') ;};
